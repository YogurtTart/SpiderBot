...
void initial(){
  ...
  delay(1000); // Pause for 1 seconds after shoulder movements
  Elbows(140, 40, 40, 140);// 8 , 11 , 2 ,5 
  delay(1000); // Pause for 1 seconds after elbow movements
...
delay(500); // Pause for 0.5 seconds after elbow movements
Hands(150, 70, 110, 110);// 3, 12, 6, 9 

for(int i = 0; i <3; i++){
  Shoulder(155, 135, 45, 45);// 4, 13, 10, 7
  delay(200); // Pause for 0.2 seconds after elbow movements
  Shoulder(135, 135, 45, 45);// 4, 13, 10, 7
  }
